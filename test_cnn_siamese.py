...
# remove last layer
s_model = siamese.build_siamese(model, model, last_layer, nb_classes)

# let's train the model using SGD + momentum
# stochastic gradient descent
sgd = SGD(lr=0.01, decay=1e-6, momentum=0.9, nesterov=True)
s_model.compile(loss='categorical_crossentropy', optimizer=sgd)

if not data_augmentation:
    print('Not using data augmentation.')
    s_model.fit(X_train, Y_train, batch_size=batch_size,
    ...
    s_model.fit_generator(datagen.flow(X_train, Y_train,
...
s_model.save_weights('my_model_weights.h5')
